...
class RdfParser:
    ...
    def do():
        ...
        for idx, dir in enumerate(dirs):
            ...
            authors_birthdate_x   = doc.xpath('//dcterms:creator/pgterms:agent/pgterms:birthdate/text()', namespaces=GutenbergCacheSettings.NS)
            ...
            authors_birthdate  =  -1 if not authors_birthdate_x or authors_birthdate_x[0] =='None' else int(authors_birthdate_x[0])
